...
import pizzaria.modelo.TabelaVenda;
import pizzaria.modeloDao.VendaDao;
import pizzaria.modelo.Venda;

public class JDCnsVenda extends javax.swing.JDialog {

    /** Creates new form JDCnsEstado */
    private TabelaVenda tblVenda = new TabelaVenda();
    private VendaDao vendadao;
    private Venda venda = null;

    public JDCnsVenda(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        getRootPane().setDefaultButton(btBusca);

    // Inicializa padrões da tabela
    jtbdados.setModel(tblVenda);
    setTamColunas();
    ...
    private void btBuscaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBuscaActionPerformed
        try {
        vendadao.selecionarPorFunc(jtNome.getText());
        tblVenda.setResultados(vendadao.getLista());
    ...
    private void btOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btOkActionPerformed
     ...
     this.venda = tblVenda.getVenda(jtbdados.getSelectedRow());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDCnsVenda dialog = new JDCnsVenda(new javax.swing.JFrame(), true);
    ...
    jtbdados.getColumnModel().getColumn(i).setMinWidth(tblVenda.getColumnSize(i));
    jtbdados.getColumnModel().getColumn(i).setMaxWidth(tblVenda.getColumnSize(i));
    }
    jtbdados.getTableHeader().setResizingAllowed(false);
    jtbdados.getTableHeader().setReorderingAllowed(false);
    }

    public Venda exibeConsulta() {
    this.setModal(true);
