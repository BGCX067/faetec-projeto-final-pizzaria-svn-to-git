...
import pizzaria.modelo.TabelaBairro;
import pizzaria.modeloDao.BairroDAO;

public class JDCnsBairro extends javax.swing.JDialog {

    /** Creates new form JDCnsEstado */
    private TabelaBairro tblBairro = new TabelaBairro();
    private BairroDAO bairrodao;
    private Bairro bairro = null;

    public JDCnsBairro(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        getRootPane().setDefaultButton(btBusca);

    // Inicializa padrões da tabela
    jtbdados.setModel(tblBairro);
    setTamColunas();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consulta de Bairro");
        ...
        setBounds((screenSize.width-492)/2, (screenSize.height-387)/2, 492, 387);
    }// </editor-fold>//GEN-END:initComponents

    private void btBuscaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBuscaActionPerformed
        try {
        bairrodao.selecionarPorNome(jtNome.getText());
        tblBairro.setResultados(bairrodao.getLista());
    ...
    private void btOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btOkActionPerformed
     ...
     this.bairro = tblBairro.getBairro(jtbdados.getSelectedRow());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDCnsBairro dialog = new JDCnsBairro(new javax.swing.JFrame(), true);
    ...
    jtbdados.getColumnModel().getColumn(i).setMinWidth(tblBairro.getColumnSize(i));
    jtbdados.getColumnModel().getColumn(i).setMaxWidth(tblBairro.getColumnSize(i));
    }
    jtbdados.getTableHeader().setResizingAllowed(false);
    jtbdados.getTableHeader().setReorderingAllowed(false);
    }

    public Bairro exibeConsulta() {
    this.setModal(true);
